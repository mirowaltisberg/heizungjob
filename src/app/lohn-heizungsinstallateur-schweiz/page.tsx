...
export const metadata: Metadata = {
  title: "Lohn Heizungsinstallateur Schweiz 2026 | Gehalt nach Beruf, Kanton & Erfahrung",
  description:
    "Wie viel verdient ein Heizungsinstallateur in der Schweiz? Lohn nach Beruf, Kanton, Erfahrung und Spezialisierung — Daten 2026.",
  alternates: { canonical: "/lohn-heizungsinstallateur-schweiz" },
};
...
const ROLE_SALARIES: { role: string; entry: string; mid: string; senior: string; slug: string }[] = [
  { role: "Heizungsinstallateur EFZ", entry: "65'000 – 73'000", mid: "75'000 – 88'000", senior: "85'000 – 100'000", slug: "heizungsinstallateur-efz" },
  { role: "Heizungsmonteur EFZ", entry: "60'000 – 68'000", mid: "70'000 – 80'000", senior: "78'000 – 90'000", slug: "heizungsmonteur-efz" },
  { role: "Wärmepumpen-Techniker", entry: "70'000 – 78'000", mid: "82'000 – 95'000", senior: "92'000 – 110'000", slug: "waermepumpen-techniker" },
  { role: "Servicetechniker Heizung", entry: "70'000 – 78'000", mid: "80'000 – 92'000", senior: "90'000 – 105'000", slug: "servicetechniker-heizung" },
  { role: "Haustechniker", entry: "65'000 – 73'000", mid: "75'000 – 90'000", senior: "88'000 – 105'000", slug: "haustechniker" },
  { role: "Projektleiter Heizung", entry: "78'000 – 88'000", mid: "90'000 – 108'000", senior: "105'000 – 130'000", slug: "projektleiter-heizung" },
];

const FAQS = [
  {
    question: "Wie viel verdient ein Heizungsinstallateur in der Schweiz?",
    answer:
      "Ein Heizungsinstallateur in der Schweiz verdient im Durchschnitt zwischen CHF 70'000 – 92'000 pro Jahr — abhängig von Beruf, Erfahrung, Kanton und Arbeitgeber. Berufseinsteiger nach EFZ-Lehrabschluss starten am unteren Ende, mit drei bis fünf Jahren Erfahrung verschiebt sich das Salärband nach oben. Spezialisierungen, Weiterbildungen und der 13. Monatslohn (in der Branche Standard) erhöhen das Jahreseinkommen zusätzlich.",
  },
  {
    question: "Welcher Kanton zahlt Heizungsinstallateur am besten?",
    answer:
  ...
  {
    question: "Gilt der GAV für mich als Heizungsinstallateur in der Schweiz?",
    answer:
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Lohn Heizungsinstallateur Schweiz", item: `${SITE_URL}/lohn-heizungsinstallateur-schweiz` },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Lohn Heizungsinstallateur Schweiz 2026",
  description: "Übersicht der Löhne für Heizungsinstallateur in der Schweiz — nach Beruf, Erfahrung und Kanton.",
  datePublished: "2026-05-08",
  dateModified: "2026-05-08",
  author: { "@type": "Organization", name: "heizungjob.ch" },
  publisher: {
    "@type": "Organization",
    name: "heizungjob.ch",
      ...
      <main className="bg-white">
        <section className="bg-primary/5 border-b">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            <nav className="text-sm text-slate-500 mb-3" aria-label="Breadcrumb">
              ...
              <span className="text-slate-700">Lohn Heizungsinstallateur Schweiz</span>
            </nav>
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Lohn <span className="text-primary">Heizungsinstallateur</span> Schweiz 2026
            </h1>
            <p className="text-slate-600 text-lg leading-relaxed max-w-3xl">
              Aktuelle Löhne für Heizungsinstallateur in der Schweiz — nach Beruf, Erfahrungsstufe und Kanton. Daten Stand 2026, basierend auf GAV Heizung-Lüftung-Klima (suissetec), Lohnstrukturerhebung BFS und unseren eigenen Auswertungen von Stelleninseraten.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-5xl">
          ...
          <p className="text-slate-600 mb-6">
            Bruttojahreslöhne in CHF (12 × Monatslohn, ohne 13. ML und Boni) für die wichtigsten Berufe der Heizung-Branche in der Schweiz.
          </p>
        ...
        <section className="bg-slate-50 border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-5xl">
            ...
            <p className="text-slate-600 mb-5">
              Lohn-Bandbreiten für Heizungsinstallateur in den grössten Schweizer Städten:
            </p>
        ...
        <section className="bg-primary/5 border-t">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-3xl text-center">
            ...
            <p className="text-slate-600 mb-5">
              Stöbere durch tausende offene Heizungsinstallateur Stellen in der Schweiz — täglich aktualisiert.
            </p>
            <Button asChild>
