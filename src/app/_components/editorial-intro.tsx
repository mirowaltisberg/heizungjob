...
import type { EditorialContent } from "@/data/editorial/heizungjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/heizungjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Heizungsinstallateur EFZ" */
  role: string;
  /** Display label for the canton, e.g. "Bern" */
  canton: string;
