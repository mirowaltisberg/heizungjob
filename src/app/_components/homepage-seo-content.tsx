...
const HOMEPAGE_FAQS = [
  {
    question: "Welche Stellen finde ich auf heizungjob.ch?",
    answer:
      "Die Suche bündelt öffentlich zugängliche Stelleninserate mit klarem Bezug zum Heizungsgewerk. Dazu können Stellen für Heizungsinstallateurinnen und Heizungsinstallateure, Heizungsmonteurinnen und Heizungsmonteure, Servicetechnik Heizung, Heizungsplanung und Projektleitung Heizung gehören. Welche Treffer vorhanden sind, zeigt die aktuelle Ergebnisliste; heizungjob.ch verspricht weder eine vollständige Abdeckung des Schweizer Arbeitsmarkts noch eine bestimmte Zahl an Inseraten.",
  },
  {
    question: "Wie suche ich nach einem Heizungjob?",
    answer:
      "Gib eine Berufsbezeichnung oder ein Heizung-Stichwort und bei Bedarf einen Ort ein. Die Ergebnisliste lässt sich mit den angebotenen Filtern weiter eingrenzen. Massgebend für Aufgaben, Qualifikation, Pensum, Arbeitsort und Lohn sind die Angaben im jeweiligen Inserat. Fehlt eine Angabe, ergänzt heizungjob.ch dafür keine pauschale Schätzung.",
  },
  {
  ...
  {
    question: "Wie lange dauert die Lehre als Heizungsinstallateur/in EFZ?",
    answer:
      "Das offizielle Berufsprofil von berufsberatung.ch nennt für die berufliche Grundbildung Heizungsinstallateur/in EFZ eine Dauer von vier Jahren und den Abschluss mit eidgenössischem Fähigkeitszeugnis. Die obligatorische Schule muss abgeschlossen sein. Details zu Ausbildung, Aufgaben und Weiterbildung stehen im verlinkten Berufsprofil und in den Ausbildungsdokumenten von suissetec.",
  },
  {
    question: "Wie kann ich einen Lohn für eine Heizungsstelle vergleichen?",
    answer:
...
export function HomepageSeoContent() {
  return (
    <section className="editorial-surface" aria-label="Informationen für Heizungs-Fachkräfte">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-14 sm:py-20 max-w-6xl">
        ...
        <div className="self-start">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-foreground mb-5">
            Heizungjobs in der Schweiz suchen
          </h2>
          <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-4">
            heizungjob.ch bündelt Stelleninserate mit klarem Bezug zum
            Heizungsgewerk. Suche nach Beruf und Ort und prüfe auf der Detailseite
        ...
        <div className="source-panel p-6 sm:p-8">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                berufsberatung.ch: Heizungsinstallateur/in EFZ
              </a>
            </li>
            <li>
              <a
          ...
          <Link
            href="/lohn-heizungsinstallateur-schweiz"
        ...
        <div className="mb-8 border-t border-border pt-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-3">
            Heizungsstellen nach Beruf und Kanton
          </h2>
