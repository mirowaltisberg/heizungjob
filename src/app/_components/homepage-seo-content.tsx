...
const HOMEPAGE_FAQS = [
  {
    ...
    answer:
      "Auf heizungjob.ch findest du offene Stellen für Heizungsinstallateur EFZ, Servicemonteur Heizung, Wärmepumpen-Spezialist, Projektleiter HLKS, Heizungsplaner, Kältetechniker, Heizungsmonteur, Feuerungskontrolleur, Anlagenmechaniker SHK, Bauleiter HLKS und Betriebstechniker Heizung — in der ganzen Schweiz.",
  },
  {
    question: "Was verdient ein Heizungsinstallateur in der Schweiz?",
    answer:
      "Ein Heizungsinstallateur EFZ verdient in der Schweiz durchschnittlich zwischen CHF 72'000 und CHF 92'000 pro Jahr. Das Gehalt variiert je nach Kanton, Berufserfahrung und Arbeitgeber. In Zürich, Zug und Basel liegen die Löhne tendenziell höher als in ländlicheren Regionen. Spezialisten für Wärmepumpen und HLKS-Projektleiter können deutlich mehr verdienen.",
  },
  {
    question: "Wie finde ich einen Job als Heizungsmonteur in der Schweiz?",
    answer:
      "Auf heizungjob.ch kannst du gezielt nach Heizungsjobs in deiner Region suchen. Nutze die Filteroptionen nach Beruf, Kanton, Pensum und Umkreis. Du kannst dich direkt über die Plattform bewerben — einfach Lebenslauf hochladen und abschicken.",
  },
  {
    question: "Welche Kantone haben die meisten Heizungsjobs?",
    answer:
      "Die meisten offenen Stellen für Heizungs-Fachkräfte gibt es in den Kantonen Zürich, Bern, Aargau, Basel und St. Gallen. Diese Regionen haben eine hohe Dichte an Heizungsinstallationsfirmen, Sanierungsprojekten und Neubauten. Durch den Boom bei Wärmepumpen und der Energiewende steigt die Nachfrage schweizweit stark an.",
  },
  {
    question: "Was ist der Unterschied zwischen Heizungsinstallateur und Heizungsmonteur?",
    answer:
      "Der Heizungsinstallateur EFZ (4-jährige Lehre) plant und installiert Heizungs- und Sanitäranlagen eigenständig und übernimmt Projektverantwortung. Der Heizungsmonteur EFZ (3-jährige Lehre) führt hauptsächlich Montage- und Servicearbeiten unter Anleitung aus. Beide Berufe sind in der Schweiz sehr gefragt, besonders im Bereich Wärmepumpen und erneuerbare Energien.",
  },
  {
    question: "Gibt es auf heizungjob.ch auch Teilzeitstellen für Heizungs-Fachkräfte?",
    answer:
      "Ja, auf heizungjob.ch findest du sowohl Vollzeit- als auch Teilzeitstellen im Bereich Heizung, Lüftung, Klima und Sanitär (HLKS). Nutze den Pensum-Filter, um Stellen mit 60–80% oder 80–100% Arbeitspensum zu finden. Besonders im Servicebereich und bei Planungsstellen sind Teilzeitmodelle verbreitet.",
  },
];
