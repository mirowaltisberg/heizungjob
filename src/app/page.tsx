...
const homepageMetadata: Metadata = {
  ...
  description:
    "Finde Stellenangebote für Heizungsinstallateur EFZ, Heizungsmonteur, Servicetechnik, Planung und Projektleitung Heizung in der Schweiz.",
          ...
          <section className={`trade-hero relative z-20 overflow-visible ${hasActiveSearch ? "pb-5 pt-8 sm:pb-7 sm:pt-10 md:pt-12" : "pb-6 pt-10 sm:pb-9 sm:pt-14 md:pt-20"}`}>
            <div className="container mx-auto max-w-6xl px-4 sm:px-6">
              <div className="trade-hero-grid">
                <div>
                  <p className="trade-kicker">Heizung · Schweizweit</p>
                  <h1 className="trade-display">
                    Wärme braucht
                    <em>Fachkräfte.</em>
                  </h1>
                  <p className="mt-5 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-lg">
                    Stelleninserate für Heizungsinstallation, Montage, Planung, Service und Projektleitung. Kompakt filtern nach Beruf, Ort und Pensum.
                  </p>
                </div>
                <div className="thermal-schematic" aria-hidden="true">
                  <svg viewBox="0 0 360 230" focusable="false">
                    <path className="thermal-schematic__line" d="M18 28h82v48h82v-25h80v80h78" />
                    <path className="thermal-schematic__return" d="M340 184h-88v-28h-102v42H62v-56H18" />
                    <circle cx="100" cy="76" r="8" />
                    <circle cx="262" cy="131" r="8" />
                    <path className="thermal-schematic__radiator" d="M155 35v80m14-80v80m14-80v80m14-80v80" />
                  </svg>
                  <span className="thermal-schematic__label">Vorlauf 01 · Stellensuche CH</span>
                </div>
              </div>
