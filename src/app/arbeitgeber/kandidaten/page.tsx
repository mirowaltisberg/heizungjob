...
export const metadata: Metadata = {
  ...
  description:
    "Erhalten Sie Zugang zum Kandidatenpool von heizungjob.ch — qualifizierte Heizungs-Fachkräfte in der Schweiz.",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-lg">
        ...
        <p className="text-slate-600 mb-6 leading-relaxed">
          Mit dem Kandidatenzugang von heizungjob.ch finden Sie qualifizierte
          Heizungs-Fachkräfte in der ganzen Schweiz. Dieser Service befindet sich
          derzeit im Aufbau.
        </p>
