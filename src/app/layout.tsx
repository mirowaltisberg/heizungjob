...
const organizationSchema = {
  ...
  description:
    "heizungjob.ch ist die spezialisierte Jobbörse für Heizungs-Fachkräfte in der Schweiz. Finde offene Stellen als Heizungsinstallateur, Servicemonteur Heizung, Projektleiter HLKS und mehr.",
  foundingDate: "2025",
  areaServed: {
    "@type": "Country",
    name: "Switzerland",
  ...
  sameAs: [
    "https://www.youtube.com/@heizungjob",
    "https://www.facebook.com/heizungjob",
    "https://www.instagram.com/heizungjob",
    "https://www.linkedin.com/company/heizungjob",
    "https://twitter.com/heizungjob",
  ],
};
