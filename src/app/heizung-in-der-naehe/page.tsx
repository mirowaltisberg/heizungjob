...
export const metadata: Metadata = {
  ...
  description:
    "Heizungsstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/heizung-in-der-naehe" },
  openGraph: {
    title: "Heizungsinstallateur in der Nähe | Jobs in deiner Stadt finden",
    description: "Heizungsstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/heizung-in-der-naehe",
    type: "website",
  },
  twitter: {
