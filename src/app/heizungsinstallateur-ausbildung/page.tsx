...
export const metadata: Metadata = {
  title: "Heizungsinstallateur Ausbildung Schweiz | EFZ & EBA",
  description:
    "Offizielle Grundlagen zur Ausbildung Heizungsinstallateur/in EFZ und Heizungspraktiker/in EBA in der Schweiz.",
  alternates: { canonical: "/heizungsinstallateur-ausbildung" },
  openGraph: {
    title: "Heizungsinstallateur Ausbildung Schweiz | EFZ & EBA",
    description:
      "Offizielle Grundlagen zur Ausbildung Heizungsinstallateur/in EFZ und Heizungspraktiker/in EBA in der Schweiz.",
    url: "/heizungsinstallateur-ausbildung",
    type: "article",
  },
  twitter: {
...
const FAQS = [
  {
    question: "Wie lange dauert die Lehre Heizungsinstallateur/in EFZ?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Laut Berufsprofil findet die praktische Ausbildung in einem Heizungsbetrieb oder einem gemischten Betrieb statt. Genannt werden vier Tage pro Woche im Betrieb, ein Tag pro Woche an der Berufsfachschule sowie überbetriebliche Kurse. Die konkrete Organisation kann kantonal und betrieblich ausgestaltet sein.",
  },
  {
    question: "Gibt es eine EBA-Ausbildung im Heizungsbereich?",
    answer:
      "Ja. Das offizielle Profil Heizungspraktiker/in EBA nennt eine zweijährige Grundbildung. Nach dem EBA ist in der Regel eine verkürzte Lehre als Heizungsinstallateur/in EFZ möglich; die konkrete Anrechnung ist mit der zuständigen Stelle zu klären.",
  },
  {
    question: "Welche Weiterbildungen nennt das offizielle Berufsprofil?",
    answer:
      "berufsberatung.ch nennt unter anderem Kurse von suissetec, die Berufsprüfung Chefmonteur/in Heizung BP und die höhere Fachprüfung Heizungsmeister/in HFP. Für jede Weiterbildung gelten eigene Zulassungsbedingungen.",
  },
  {
    question: "Wo finde ich Lehrstellen?",
    answer:
      "Die offizielle Lehrstellensuche von berufsberatung.ch listet Lehrstellen nach Beruf und Region. Zusätzlich können Lehrbetriebe eigene Ausschreibungen publizieren. heizungjob.ch verspricht keine vollständige Lehrstellenabdeckung.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Startseite", item: SITE_URL },
    {
      "@type": "ListItem",
      position: 2,
      name: "Heizungsinstallateur Ausbildung",
      item: `${SITE_URL}/heizungsinstallateur-ausbildung`,
    },
  ],
};
      ...
      <main id="main-content" className="bg-background">
        <section className="trade-hero">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            <nav className="text-sm text-slate-600 mb-3" aria-label="Breadcrumb">
              ...
              <span className="text-slate-700">Heizungsinstallateur Ausbildung</span>
            </nav>
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Ausbildung <span className="text-primary">Heizungsinstallateur/in EFZ</span>
            </h1>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
          ...
          <p className="text-slate-600 mb-3 leading-relaxed">
            Die berufliche Grundbildung Heizungsinstallateur/in EFZ dauert vier
          ...
          <a
            href="https://www.berufsberatung.ch/de/berufe/heizungsinstallateur-in-efz"
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary underline"
          >
            Quelle: berufsberatung.ch – Heizungsinstallateur/in EFZ
          </a>
        </section>
        ...
        <section className="editorial-surface border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
            ...
            <p className="text-slate-600 mb-3 leading-relaxed">
              Die Grundbildung Heizungspraktiker/in EBA dauert zwei Jahre. Nach
              dem Abschluss ist laut offiziellem Berufsprofil in der Regel eine
              verkürzte Lehre als Heizungsinstallateur/in EFZ möglich. Ob und wie
              eine Verkürzung im Einzelfall erfolgt, klären Lernende mit der
              zuständigen Berufsbildungsstelle.
            </p>
            <a
              href="https://www.berufsberatung.ch/de/berufe/heizungspraktiker-in-eba"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary underline"
            >
              Quelle: berufsberatung.ch – Heizungspraktiker/in EBA
            </a>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
          ...
          <ul className="space-y-3 text-slate-700 mb-5">
            ...
            <li className="trade-panel p-4">
              <strong className="text-slate-900">Berufsprüfung</strong> — Chefmonteur/in Heizung BP gemäss offiziellem Berufsprofil.
            </li>
            <li className="trade-panel p-4">
              <strong className="text-slate-900">Höhere Fachprüfung</strong> — Heizungsmeister/in HFP gemäss offiziellem Berufsprofil.
            </li>
          </ul>
          <a
            href="https://suissetec.ch/de/heizungsinstallateur-in-efz.html"
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary underline"
          >
        ...
        <section className="editorial-surface border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
            ...
            <Link href="/lohn-heizungsinstallateur-schweiz" className="text-primary underline">
