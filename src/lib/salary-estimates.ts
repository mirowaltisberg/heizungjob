/**
 * Approximate annual CHF salary ranges for Swiss heating trade roles (HLKS/SHK)
 * and general technical trades. Used when no salary data is available from the job source.
 */
...
const ROLE_SALARY_MAP: { patterns: string[]; range: SalaryRange }[] = [
  // Heating-specific roles (HLKS / SHK)
  {
    patterns: ["bauleiter hlks", "bauleiter heizung"],
    range: { min: 90_000, max: 120_000 },
  },
  {
    patterns: ["projektleiter hlks", "projektleiter heizung"],
    range: { min: 85_000, max: 110_000 },
  },
  {
    patterns: ["wärmepumpen", "waermepumpen"],
    range: { min: 75_000, max: 95_000 },
  },
  {
    patterns: ["heizungsplaner", "planer hlks", "planer heizung"],
    range: { min: 78_000, max: 98_000 },
  },
  {
    patterns: ["kältetechniker", "kaeltetechniker"],
    range: { min: 72_000, max: 92_000 },
  },
  {
    patterns: ["heizungsinstallateur"],
    range: { min: 72_000, max: 90_000 },
  },
  {
    patterns: ["betriebstechniker heizung"],
    range: { min: 72_000, max: 90_000 },
  },
  {
    patterns: ["servicemonteur heizung"],
    range: { min: 70_000, max: 88_000 },
  },
  {
    patterns: ["anlagenmechaniker"],
    range: { min: 70_000, max: 88_000 },
  },
  {
    patterns: ["feuerungskontrolleur"],
    range: { min: 68_000, max: 85_000 },
  },
  {
    patterns: ["heizungsmonteur"],
