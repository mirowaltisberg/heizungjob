...
const DEFAULT_QUERY = "Heizungsinstallateur";
...
const ROLE_TEMPLATES = [
  ...
  "Inbetriebnahme-Techniker Heizung",
];
...
const RESPONSIBILITY_TEMPLATES = [
  ...
  "Montage und Anschluss von Wärmepumpen und Wärmeerzeugern.",
  "Durchführung von Wartungs- und Servicearbeiten an Heizungsanlagen.",
  "Fehlersuche und Störungsbehebung bei Kunden vor Ort.",
  "Dokumentation der ausgeführten Arbeiten und Anlagenparameter.",
  "Zusammenarbeit mit Bauleitung, Planern und weiteren Gewerken.",
  "Einhaltung von Sicherheits- und Qualitätsstandards gemäss SVGW.",
  "Mithilfe bei Materialdisposition und Arbeitsvorbereitung.",
  "Einregulierung und Optimierung von Heizkreisen und Pumpen.",
  "Begleitung von Abnahmen, Übergaben und Einweisungen.",
  "Verlegung von Rohrleitungen und Dämmarbeiten.",
  "Mitarbeit bei der Optimierung von Montageabläufen.",
];

const REQUIREMENT_TEMPLATES = [
  "Abgeschlossene Ausbildung im Heizungsbereich (EFZ oder gleichwertig).",
  "Sorgfältige und selbstständige Arbeitsweise.",
  "Teamfähigkeit und klare Kommunikation auf Deutsch.",
  "Erfahrung in Neu- und Umbauprojekten von Vorteil.",
  "Sicherer Umgang mit Installations- und Schemaplänen.",
  ...
  "Gute Kenntnisse der Schweizer Normen und SVGW-Richtlinien.",
...
function buildGeneratedJob(
  ...
  const focusText = primaryFocus
    ...
    : "mit Fokus auf moderne Heizungsprojekte";
