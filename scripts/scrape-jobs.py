"""Scrape a fresh chunk of genuine Swiss heating jobs into JSON.
...
from job_safety import CONFIG as JOB_SAFETY_CONFIG, classify_heizung_title
...
def is_relevant_job(job: dict) -> bool:
    """Return True only for clearly heating-related Swiss roles."""
    ...
    return classify_heizung_title(title)["disposition"] == "ACCEPT"
...
DEFAULT_SEARCH_TERMS = [
    ...
    "Inbetriebnahmetechniker Heizung",
...
def main():
    parser = argparse.ArgumentParser(description="Scrape Swiss heating jobs")
